...
RSpec.describe Importer do
  describe '#guild_list' do
    ...
    describe 'execute_update: true' do
      example '全てのレコードが INSERT のときに実行が成功すること' do
        result = Importer.guild_list(guild_list_response)
      ...
      example '全てのレコードが UPDATE のときに実行が成功すること' do
        Importer.guild_list(guild_list_response)
        ...
        result = Importer.guild_list(guilds_for_all_update)
      ...
      example 'INSERT と UPDATE のレコードが混在しているときに実行が成功すること' do
        ...
        result = Importer.guild_list(guilds_for_insert_and_update)
  ...
  describe '#channel_list' do
    ...
    describe 'guild_id_number: nil' do
      example '全てのレコードが INSERT のときに実行が成功すること' do
        result = Importer.channel_list(channel_list_response, guild_id_number: nil)
